...
module.exports = {
    ...
    createTodo: async (req, res)=>{
        try{
            await Todo.create({todo: req.body.todoItem, completed: false, userId: req.user.id, dateCreated:new Date().toLocaleDateString('en-us', { month:"short", day:"numeric"}), dateCreated: "Not Completed" })
